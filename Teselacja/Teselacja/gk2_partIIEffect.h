#ifndef __GK2_PARTII_EFFECT_H_
#define __GK2_PARTII_EFFECT_H_

#include "gk2_effectBase.h"

namespace gk2
{
	class PartIIEffect : public gk2::EffectBase
	{
	public:
		PartIIEffect(gk2::DeviceHelper& device, std::shared_ptr<ID3D11InputLayout>& layout,
