...
XMMATRIX LightShadowEffect::UpdateLight(float dt, shared_ptr<ID3D11DeviceContext> context)
{
	...
	XMVECTOR lightTarget = XMVector3TransformCoord(XMLoadFloat4(&lt), lamp);
	XMVECTOR up;
	up.m128_f32[0] = 1.0f;
	...
	XMMATRIX texMtx = m_lightViewMtx * m_lightProjMtx *  XMMatrixScaling(0.5f, -0.5f, 1.0f) * XMMatrixTranslation(0.5f, 0.5f, -0.00001f);
