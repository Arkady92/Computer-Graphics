#ifndef __GK2_CUBIC_MAPPER_H_
#define __GK2_CUBIC_MAPPER_H_
...
namespace gk2
{
	class CubeMapper : public EffectBase
	{
	public:
		CubeMapper(gk2::DeviceHelper& device, std::shared_ptr<ID3D11InputLayout>& layout,
